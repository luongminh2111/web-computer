...
/**
 * SurfaceSearch represents the model behind the search form of `common\models\Surface`.
 */
class SurfaceSearch extends Surface
{
    ...
    {
        return [
            [['cpt_name', 'category', 'cpu', 'ram', 'hardware', 'screen', 'graphicscard', 'guarantee', 'description', 'image', 'title', 'slug', 'image_show'], 'safe'],
            [['cost'], 'integer'],
        ];
    }
