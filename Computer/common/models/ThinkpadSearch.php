...
/**
 * ThinkpadSearch represents the model behind the search form of `common\models\Thinkpad`.
 */
class ThinkpadSearch extends Thinkpad
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['title', 'cpt_name', 'category', 'cpu', 'ram', 'hardware', 'screen', 'graphicscard', 'image', 'guarantee', 'description', 'slug', 'image_show'], 'safe'],
            [['cost'], 'integer'],
        ];
    }
